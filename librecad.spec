...
%define	version	1.0.0beta5_116_g88b5983

Summary: 	Computer-aided design (CAD) system
Name: 		%{name}
Version: 	%{version}
Release: 	%mkrel 1
# generated by git archive --format=tar --prefix=librecad-$(git describe --tags | sed -e 's/-/_/g')/ master | bzip2 > librecad-$(git describe --tags | sed -e 's/-/_/g').tar.bz2
Source0:	librecad-%{version}.tar.bz2
Patch0:		0001-fix-String-formatting-error.patch
Patch1:		0002-Updating-french-translation.patch
Patch2:		librecad.desktop.patch
Patch4:		plugindir32.patch
Patch5:		plugindir64.patch
